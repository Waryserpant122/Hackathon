...
var Particle = function () {
        this.pos = new Vector();
        this.pos.x =100+ 400* Math.random();
        this.pos.y = 100+ 400* Math.random();
        this.t= Math.random()
       ...
       this.checkHit = function(other)
       {
        ...
        if (Math.pow(dx,2)+Math.pow(dy,2) <= rSq) {
            ...
            //var q =this.mass/(Math.pow(this.r,2))+other.mass/Math.pow(other.r,2);
